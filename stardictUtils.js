...
const convertDZFileToText = async (dzfile) => {
  const fd = fs.openSync(dzfile, 'r')
  let buf = Buffer.alloc();
  let output = fs.readSync(fd, buf, 0);
  console.log('=============output show here');
...
const getArticleBodyfromDZ2 = (dzfile, ArtInfo) => {
...
module.exports = {
  ...
  convertDZFileToText: convertDZFileToText,
